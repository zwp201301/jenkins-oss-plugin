...
public enum ContentTypeEnum {
    ...
    ContentTypeEnum(String surffix, String contentType) {
    ...
    public static String getContentType(String surffix) {
        if (StrUtil.isEmpty(surffix)) {
            return DEFAULT.getContentType();
        }
        for (ContentTypeEnum value : ContentTypeEnum.values()) {
            if (surffix.equalsIgnoreCase(value.getSurffix())) {
